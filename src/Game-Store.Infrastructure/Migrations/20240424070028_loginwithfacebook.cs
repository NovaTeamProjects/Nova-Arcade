        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RatingsGuide = table.Column<string>(type: "text", nullable: false),
                    ...
                    Publisher = table.Column<string>(type: "character varying(80)", maxLength: 80, nullable: false),
                    ...
                    SysReqId = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Games_AspNetUsers_UserId2",
                        column: x => x.UserId2,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Games_SystemRequirements_SysReqId",
                        column: x => x.SysReqId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GameEdition", x => x.Id);
                    table.ForeignKey(
                        name: "FK_GameEdition_Games_GameId",
                        column: x => x.GameId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GameEdition_GameId",
                table: "GameEdition",
                column: "GameId");

            migrationBuilder.CreateIndex(
                name: "IX_Games_SysReqId",
                table: "Games",
                column: "SysReqId");
